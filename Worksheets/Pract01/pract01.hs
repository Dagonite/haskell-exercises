...
-- Can see what this does by typing:
-- > mult2 4
...
-- 7. Using the mod function, write a function that tests whether one integer is divisibleby another.
